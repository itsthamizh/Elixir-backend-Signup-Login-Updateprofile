defmodule LoginWeb.UserAuthTest do
  use LoginWeb.ConnCase, async: true

  alias Login.Users
  alias LoginWeb.UserAuth
  import Login.UsersFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LoginWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LoginWeb.Endpoint.subscribe(live_socket_id)
